...
is important to state the possibility to aggregate (sum) signatures into compact
...
scenario implementation is contained inside the zencode_credential.lua
and zencode_multidarkroom.lua source files found in the Zenroom source
code.
