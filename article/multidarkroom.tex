...
\begin{itemize}
  \item[1.] One may choose a document and decide to indict its signature
  \item[2.] One selects the participants to the signature and publishes it
  \item[3.] Participants may chose to add their signature to the document
  \item[4.] Anyone may verify the document is signed by all and only all participants
\end{itemize}
...
Our benchmarks provide lab measurements for the 3 main steps in the signature flow: for each of them is reported the time of execution (expressed in $\mu$s) and the size of output (expressed in bytes) in different conditions with a progressive number $N$ of participants (5, 10, 50, 100 signatures).
...
\begin{table}[h!]
  \begin{center}
    \caption{Execution timings on \textbf{X86 64bit} in $\mu$s}
    \label{tab:table1}
    \begin{tabular}{l|c|c|r}
      \toprule % titles
      \textbf{N} & \textbf{create} & \textbf{sign} & \textbf{verify}\\
      \midrule
...
\begin{table}[h!]
  \begin{center}
    \caption{Execution timings on \textbf{ARM 64bit} in $\mu$s}
    \label{tab:table1}
    \begin{tabular}{l|c|c|r}
      \toprule % titles
      \textbf{N} & \textbf{create} & \textbf{sign} & \textbf{verify}\\
...
\begin{table}[h!]
  \begin{center}
    \caption{Execution timings on \textbf{ARM 32bit} in $\mu$s}
    \label{tab:table1}
    \begin{tabular}{l|c|c|r}
      \toprule % titles
      \textbf{N} & \textbf{create} & \textbf{sign} & \textbf{verify}\\
