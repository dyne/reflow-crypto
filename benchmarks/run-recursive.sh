...
rm -f /dev/shm/files/multisignature.json
create_multisignature
...
cp -v -f /dev/shm/files/multisignature.json /dev/shm/files/multisignature_temp.json
...
cp -v /dev/shm/files/multisignature.json /dev/shm/files/multisignature_temp_empty.json
...
cp -v /dev/shm/files/multisignature.json /dev/shm/files/multisignature_temp_completeMinusOne.json
...
cp -v -f /dev/shm/files/multisignature_temp_empty.json /dev/shm/files/multisignature.json
...
cp -v -f /dev/shm/files/multisignature_temp_completeMinusOne.json /dev/shm/files/multisignature.json
